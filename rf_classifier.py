...
# Now to the Main deal! The Random Forest Classification
...
classifier = RandomForestClassifier(n_estimators=1000, oob_score=True, n_jobs=-1)
...
pred_ds = gdal.Open(r"./classified/classified.tif")
